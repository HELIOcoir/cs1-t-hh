...
<div class="card card-inverse card-info">
                            <div class="card-body p-4">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="card-title p-t-10 p-t-md-0 p-t-sm-0 p-t-xs-0 no-margin">{lang key='homepage.yourAccount'}</h5>
                                </div>
                            </div>
  </div>
</a>
...
<div class="card card-inverse card-success">
                            <div class="card-body p-4">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="card-title p-t-10 no-margin">{lang key='homepage.manageServices'}</h5>
                                </div>
...
<div class="card card-inverse card-danger">
                            <div class="card-body p-4">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="card-title p-t-10 no-margin">{lang key='homepage.manageDomains'}</h5>
                                </div>
...
<div class="card card-inverse card-warning">
                            <div class="card-body p-4">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="card-title p-t-10">{lang key='homepage.supportRequests'}</h5>
                                </div>
...
<div class="card card-inverse card-primary">
                            <div class="card-body p-4">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="card-title p-t-10">{lang key='homepage.makeAPayment'}</h5>
                                </div>
