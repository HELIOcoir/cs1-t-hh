                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h3 class="">{lang key='announcementstitle'}</h3>
                                    </div>
                                <div class="col-12">
                                    <div class="progress">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h3 class="">{lang key='networkstatustitle'}</h3>
                                    </div>
                                <div class="col-12">
                                    <div class="progress">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h3 class="">{lang key='knowledgebasetitle'}</h3>
                                    </div>
                                <div class="col-12">
                                    <div class="progress">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h3 class="">{lang key='downloadstitle'}</h3>
                                    </div>
                                <div class="col-12">
                                    <div class="progress">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h3 class="">{lang key='homepage.submitTicket'}</h3>
                                    </div>
                                <div class="col-12">
                                    <div class="progress">
